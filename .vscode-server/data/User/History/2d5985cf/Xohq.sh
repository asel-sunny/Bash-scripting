...
## Giving wrong output .. checking only the first IP , but not checking 2nd . Output is below :

[root@centos-s-1vcpu-1gb-nyc1-01 class]# sh test4.sh 
"159.223.101.71"
"157.230.213.1" is active
"159.223.101.71"
"157.230.213.1" is active